...
Si se considera la red cerrada de la figura~\ref{cpn1} en donde $Q_{D_1}$, $Q_{D_2}$, $Q_{D_3}$, $\cdots$, $Q_{D_Nu}$ son los caudales demandados en los nodos donde $Nu$ es el n\'umero de nodos de la red, y $Q_{e_1}$,  $Q_{e_2}$, $\cdots$, $Q_{e_m}$ son los caudales que alimentan la red, la ecuacion de continuidad se puede escribir como:
...
\begin{equation}
\sum_{i=1}^m Q_e = \sum_{i=1}^Nu Q_D
\label{cpne1}
\end{equation}
