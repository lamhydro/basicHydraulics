...
\item Para cada una de las $n$ tuber\'ias en paralelo, hacer la comprobaci\'on de diseno para tuber\'ias simples descrito en la secci\'on~\ref{tubeSimpleCompro}. Se obtendran $n$ caudales $Q$ y $n$ velocidades $V$ para cada tuber\'ia. 
