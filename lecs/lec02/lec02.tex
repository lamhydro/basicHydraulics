...
Para utilizar el m\'etodo, es necesario estimar caudales iniciales en las tuber\'ias ($Q_{0_{ij}}$). Una de las ventajas del m\'etodos es que al suponer estos caudales iniciales no es necesario que se conserve la masa en los nodos; los caudales pueden ser los mismos en todas las tuber\'ias. 
