...
\begin{equation}
\color{red}\boxed{\color{black} f=Re/64 } 
\label{com8}
\end{equation}
...
\subsubsection*{Metodo de Newton-Raphson}
Consiste en el siguiente procedimiento:
\begin{enumerate} 
\item Leer la informaci\'on de entrada: $\varepsilon$, $\rho$, $\mu$ o $\nu$, $V$ o $Q$, $D$ 
\item Calcular el $Re$ usando la ecuaci\'on~\ref{com5}
...
Para la soluci\'on de este tipo de problema, el cual consiste en determinar el valor de $V$ o $Q$, existen dos m\'etodos: el m\'etodo de punto fijo y el m\'etodo de Newton-Raphson. Estos dos m\'etodos se describen a continuaci\'on.
...
\subsubsection*{M\'etodo de Newton-Raphson}
