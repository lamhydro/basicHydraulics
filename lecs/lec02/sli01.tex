...
\titlegraphic{\includegraphics[height=2.0cm]{figs/escudoUnal.png}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\logo{\vspace{-0.2cm}\includegraphics[height=0.8cm]{figs/escudoUnal.png}~%
}
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
\item \emph{EPANET} es desarrollado por la Agencia de Protecci\'on Ambiental (EPA por sus siglas en ingl\'es) de los Estados Unidos. La versi\'on actual es la 2.2 \href{https://www.epa.gov/water-research/epanet}{\beamergotobutton{Link}}
...
%\begin{frame}{Ejecuci\'on de un proye}
